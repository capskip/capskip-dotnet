...
If you discover a security vulnerability in the CapSkip .NET SDK, please report it responsibly.
...
This policy covers the `CapSkip` NuGet package in this repository.
